    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12">
          {[
            { icon: "🤖", title: "Matching Inteligente", desc: "Algoritmo ponderado que cruza habilidades técnicas (60%), blandas (20%), experiencia (10%), salario (5%) y disponibilidad (5%)." },
            ...
            { icon: "📊", title: "Dashboard en Tiempo Real", desc: "Panel administrativo con gráficos de embudo, usuarios activos y seguimiento de matches confirmados." },
          ].map((item, i) => (
            <motion.div
              key={i}
              initial={{ opacity: 0, y: 20 }}
